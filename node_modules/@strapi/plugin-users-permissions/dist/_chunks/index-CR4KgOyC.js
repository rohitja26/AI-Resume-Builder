...
const index6pjQxyB0 = require("./index-6pjQxyB0-qR3QHvSP.js");
...
const index = require("./index-D27wKlgt.js");
...
const ProvidersPage = () => {
  ...
  const { trackUsage } = index6pjQxyB0.useTracking();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(index6pjQxyB0.Layouts.Root, { children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsxs(admin.Page.Main, { children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(index6pjQxyB0.Layouts.Content, { children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Table, { colCount: 3, rowCount: providers.length + 1, children: [
...
//# sourceMappingURL=index-CR4KgOyC.js.map
