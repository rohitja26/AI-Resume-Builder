...
import { l as useGuidedTour, b as Layouts } from './index-6pjQxyB0.mjs';
...
const HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import('./HomePage-183EKMLK.mjs')).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=HomePage-n2buy2O4.mjs.map
