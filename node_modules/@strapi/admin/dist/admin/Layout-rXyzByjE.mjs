...
import { r as SETTINGS_LINKS_CE, b as Layouts } from './index-6pjQxyB0.mjs';
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import('./index-6pjQxyB0.mjs').then(n => n.K)).SETTINGS_LINKS_EE(),
    {
...
export { Layout };
//# sourceMappingURL=Layout-rXyzByjE.mjs.map
