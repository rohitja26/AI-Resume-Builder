...
// node_modules/@strapi/content-manager/dist/_chunks/index-c_5DdJi-.mjs
...
var ProtectedHistoryPage = (0, import_react.lazy)(
  () => import("./History-wrnHqf09-OOSWTUHP.js").then((mod) => ({ default: mod.ProtectedHistoryPage }))
);
var routes$1 = [
  {
...
var ProtectedEditViewPage = (0, import_react.lazy)(
  () => import("./EditViewPage-BLsjc5F--YO4E5KWJ.js").then((mod) => ({ default: mod.ProtectedEditViewPage }))
);
var ProtectedListViewPage = (0, import_react.lazy)(
  () => import("./ListViewPage-C4IvrMgY-Q4R5NRBB.js").then((mod) => ({ default: mod.ProtectedListViewPage }))
);
var ProtectedListConfiguration = (0, import_react.lazy)(
  () => import("./ListConfigurationPage-DScmJVkW-POPIHQ5I.js").then((mod) => ({
    default: mod.ProtectedListConfiguration
  }))
);
var ProtectedEditConfigurationPage = (0, import_react.lazy)(
  () => import("./EditConfigurationPage-DmoXawIh-SRPPPFVK.js").then((mod) => ({
    default: mod.ProtectedEditConfigurationPage
  }))
);
var ProtectedComponentConfigurationPage = (0, import_react.lazy)(
  () => import("./ComponentConfigurationPage-BAgyHiMm-BQXJB4OU.js").then((mod) => ({
    default: mod.ProtectedComponentConfigurationPage
  }))
);
var NoPermissions = (0, import_react.lazy)(
  () => import("./NoPermissionsPage-DSP7R-hv-BHWSMKU7.js").then((mod) => ({ default: mod.NoPermissions }))
);
var NoContentType = (0, import_react.lazy)(
  () => import("./NoContentTypePage-Djg8nPlj-SII7NMHX.js").then((mod) => ({ default: mod.NoContentType }))
);
        ...
        return (0, import_jsx_runtime.jsx)(
          Menu.Item,
          {
            ...
            children: (0, import_jsx_runtime.jsxs)(Flex, { justifyContent: "space-between", gap: 4, children: [
              (0, import_jsx_runtime.jsxs)(Flex, { color: convertActionVariantToColor(action.variant), gap: 2, tag: "span", children: [
                (0, import_jsx_runtime.jsx)(Box, { tag: "span", color: convertActionVariantToIconColor(action.variant), children: action.icon }),
                action.label
              ] }),
...
var PublishAction$1 = ({
  ...
  return {
     ...
     */
    disabled: isCloning || isSubmitting || isLoadingDraftRelations || activeTab === "published" || !modified && isDocumentPublished || !modified && !(document == null ? void 0 : document.documentId) || !canPublish || Boolean(!(document == null ? void 0 : document.documentId) && !canCreate || (document == null ? void 0 : document.documentId) && !canUpdate),
    label: formatMessage({
...
var StyledCrossCircle = pt(ForwardRef$3T)`
  path {
    fill: currentColor;
  }
`;
...
var StyledPencil = pt(ForwardRef$1r)`
  path {
    fill: currentColor;
  }
`;
...
var StyledDuplicate = pt(ForwardRef$3F)`
  path {
    fill: currentColor;
  }
`;
...
var index = {
  register(app) {
    ...
    app.router.addRoute({
      ...
      lazy: async () => {
        const { Layout } = await import("./layout-oPBiO7RY-XFWJMFDJ.js");
        return {
          Component: Layout
        };
      },
...
//# sourceMappingURL=chunk-U3HK2BRX.js.map
