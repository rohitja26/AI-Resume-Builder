...
// node_modules/@strapi/admin/dist/admin/HomePage-n2buy2O4.mjs
...
`;
var CloudCustomWrapper = pt(Box)`
  background-image: url(${cloudIconBackgroundImage});
`;
var CloudIconWrapper = pt(Flex)`
...
var StyledGithub = pt(ForwardRef$x)`
  path {
    fill: ${(props) => props.theme.colors.neutral800} !important;
  }
`;
var StyledDiscord = pt(ForwardRef$T)`
  path {
    fill: #7289da !important;
  }
`;
var StyledReddit = pt(ForwardRef$d)`
  > path:first-child {
    fill: #ff4500;
  }
...
`;
var StyledStrapi = pt(ForwardRef$7)`
  > path:first-child {
    fill: #4945ff;
  }
  > path:nth-child(2) {
...
`;
var StyledTwitter = pt(ForwardRef$1)`
  path:first-child {
    fill: #fff;
  }
...
`;
var StyledDiscourse = pt(ForwardRef$R)`
  > path:first-child {
    fill: #231f20;
  }
  > path:nth-child(2) {
...
var HomePage = () => {
  const Page2 = useEnterprise(
    ...
    async () => (await import("./HomePage-183EKMLK-Q7W2YPYG.js")).HomePageEE
  );
  if (!Page2) {
    return null;
  }
...
//# sourceMappingURL=chunk-BJMYZQXW.js.map
