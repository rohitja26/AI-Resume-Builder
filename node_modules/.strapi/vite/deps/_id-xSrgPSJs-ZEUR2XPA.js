...
// node_modules/@strapi/review-workflows/dist/_chunks/_id-xSrgPSJs.mjs
...
var AccordionRoot = pt(Accordion.Root)`
  border: 1px solid
    ${({ theme, $error }) => $error ? theme.colors.danger600 : theme.colors.neutral200};
`;
var DeleteMenuItem = pt(MenuItem)`
  color: ${({ theme }) => theme.colors.danger600};
`;
var ContextMenuTrigger = pt(Menu.Trigger)`
  :hover,
  :focus {
...
var NestedOption$1 = pt(MultiSelectOption)`
  padding-left: ${({ theme }) => theme.spaces[7]};
`;
var PermissionWrapper = pt(Flex)`
  > * {
    flex-grow: 1;
  }
`;
...
var NestedOption = pt(MultiSelectOption)`
  padding-left: ${({ theme }) => theme.spaces[7]};
`;
var ContentTypeTakeNotice = pt(Typography)`
  font-style: italic;
`;
                  ...
                  savePrompts.hasReassignedContentTypes && (0, import_jsx_runtime.jsx)(Typography, { textAlign: "center", variant: "omega", children: formatMessage(
                    ...
                    },
                    {
                      count: (contentTypesFromOtherWorkflows == null ? void 0 : contentTypesFromOtherWorkflows.filter(
                        (contentType) => {
                          var _a2;
                          return (_a2 = currentWorkflow == null ? void 0 : currentWorkflow.contentTypes) == null ? void 0 : _a2.includes(contentType);
                        }
                      ).length) ?? 0
                    }
                  ) }),
...
//# sourceMappingURL=_id-xSrgPSJs-ZEUR2XPA.js.map
