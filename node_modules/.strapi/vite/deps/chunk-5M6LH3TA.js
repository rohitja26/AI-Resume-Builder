...
import {
  ...
  intervalToDuration
} from "./chunk-S6APR5LV.js";
import {
  require_isEmpty
} from "./chunk-5TODOKWX.js";
import {
  parseISO
...
// node_modules/@strapi/upload/dist/_chunks/index-BBKOO690.mjs
...
import "C:/Users/user/OneDrive/Desktop/projects(MERN)/my-project/node_modules/cropperjs/dist/cropper.css";
...
var RelativeBox = pt(Box)`
  position: relative;
`;
var Wrapper$1 = pt.div`
  position: relative;
  display: flex;
...
var CroppingActionRow = pt(Flex)`
  ...
  width: 100%;
`;
var BadgeOverride = pt(Badge)`
  span {
    color: inherit;
    font-weight: ${({ theme }) => theme.fontWeights.regular};
  }
`;
var UploadProgressWrapper$1 = pt.div`
  position: absolute;
  z-index: 2;
  height: 100%;
  width: 100%;
...
var Extension$1 = pt.span`
  text-transform: uppercase;
`;
var CardActionsContainer = pt(CardActionImpl)`
  opacity: 0;
...
var AudioPreviewWrapper$1 = pt(Box)`
  canvas,
  audio {
    display: block;
    max-width: 100%;
...
var IconWrapper$1 = pt.span`
  svg {
    font-size: 4.8rem;
  }
`;
var CardAsset2 = pt(Flex)`
  border-radius: ${({ theme }) => theme.borderRadius} ${({ theme }) => theme.borderRadius} 0 0;
  background: linear-gradient(180deg, #ffffff 0%, #f6f6f9 121.48%);
`;
...
var VideoPreviewWrapper$2 = pt(Box)`
  canvas,
  video {
    display: block;
    pointer-events: none;
...
var FauxClickWrapper = pt.button`
  height: 100%;
  left: 0;
  position: absolute;
  opacity: 0;
...
`;
var StyledFolder = pt(ForwardRef$3b)`
  path {
    fill: currentColor;
  }
`;
var CardActionDisplay = pt(Box)`
  display: none;
`;
var Card2 = pt(Box)`
  &:hover,
...
var BoxOutline = pt(Box)`
  &:focus {
    outline: 2px solid ${({ theme }) => theme.colors.primary600};
    outline-offset: -2px;
  }
`;
var BoxTextDecoration = pt(BoxOutline)`
  text-decoration: none;
`;
...
var VideoPreviewWrapper$1 = pt(Box)`
  figure {
...
var PaginationText = pt(Typography)`
  line-height: revert;
`;
var LinkWrapper = pt.button`
...
var PageLinkWrapper = pt(LinkWrapper)`
...
`;
var ActionLinkWrapper = pt(LinkWrapper)`
  font-size: 1.1rem;
  svg path {
  ...
  pointer-events: none;
    ` : void 0}
`;
var DotsWrapper = pt(LinkWrapper)`
...
var TypographyMaxWidth = pt(Typography)`
  max-width: 100%;
`;
var ActionContainer = pt(Box)`
  svg {
    path {
      fill: ${({ theme }) => theme.colors.neutral500};
    }
...
var UploadProgressWrapper = pt.div`
  height: 8.8rem;
  width: 100%;
`;
var Extension = pt.span`
  text-transform: uppercase;
`;
...
var MediaLibraryDialog = ({ onClose, onSelectAssets, allowedTypes }) => {
  ...
  switch (step) {
    ...
    case STEPS$1.FolderCreate:
      return (0, import_jsx_runtime.jsx)(EditFolderDialog, { onClose: () => setStep(STEPS$1.AssetSelect), parentFolderId: folderId });
    default:
      return (0, import_jsx_runtime.jsx)(UploadAssetDialog, { onClose: () => setStep(STEPS$1.AssetSelect), folderId });
  }
};
...
var DocAsset = pt(Flex)`
  background: linear-gradient(180deg, #ffffff 0%, #f6f6f9 121.48%);
`;
var VideoPreviewWrapper = pt(Box)`
  canvas,
  video {
    max-width: 100%;
    height: 124px;
...
`;
var AudioPreviewWrapper = pt(Box)`
  canvas,
  audio {
    max-width: 100%;
  }
...
var TextAlignTypography = pt(Typography)`
  align-items: center;
`;
...
var index2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./index-x6K5gJb1-2A4OS2MT.js"),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      to: "media-library",
      Component: () => import("./index-BgpZJSsC-L23AHMVY.js"),
...
cropperjs/dist/cropper.esm.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-5M6LH3TA.js.map
