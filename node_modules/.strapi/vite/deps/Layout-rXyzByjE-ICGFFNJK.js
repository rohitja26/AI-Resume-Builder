...
// node_modules/@strapi/admin/dist/admin/Layout-rXyzByjE.mjs
...
var useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import("./index-6pjQxyB0-PCXPSKDT.js").then((n) => n.K)).SETTINGS_LINKS_EE(),
    {
...
var CustomIcon = pt(ForwardRef$2n)`
  right: 15px;
  position: absolute;
  bottom: 50%;
...
//# sourceMappingURL=Layout-rXyzByjE-ICGFFNJK.js.map
