import {
  CardDragPreview
} from "./chunk-T3T3OMJ4.js";
import {
  FieldTypeIcon
} from "./chunk-3DL5HTZ4.js";
import {
  setIn
} from "./chunk-MKBNOFB5.js";
import {
  ItemTypes,
  useDragAndDrop
} from "./chunk-U5SV25KW.js";
import {
  useTypedSelector
} from "./chunk-N6JV3NMZ.js";
import {
  getEmptyImage
...
// node_modules/@strapi/content-manager/dist/_chunks/ListConfigurationPage-DScmJVkW.mjs
...
`;
var DragButton = pt(ActionButton)`
  padding: 0 ${({ theme }) => theme.spaces[3]};
  border-right: 1px solid ${({ theme }) => theme.colors.neutral150};
  cursor: all-scroll;
`;
var FieldContainer = pt(Flex)`
  max-height: 3.2rem;
  cursor: pointer;
`;
var FieldWrapper = pt(Box)`
  &:last-child {
...
//# sourceMappingURL=ListConfigurationPage-DScmJVkW-POPIHQ5I.js.map
