...
// node_modules/@strapi/admin/dist/admin/EditPage-D5r0GV3j.mjs
...
var AddHeaderButton = pt(TextButton)`
  cursor: pointer;
`;
var HeadersInput = () => {
  const { formatMessage } = useIntl();
...
var WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-d03-9tkm-3TDGUORO.js")).EventsTableEE
  );
...
//# sourceMappingURL=chunk-RMJLERY7.js.map
