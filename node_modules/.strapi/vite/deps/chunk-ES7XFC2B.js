...
// node_modules/@strapi/admin/dist/admin/index-6pjQxyB0.mjs
...
var getEERoutes$1 = () => window.strapi.isEE ? [
  {
    ...
    lazy: async () => {
      const { AuthResponse } = await import("./AuthResponse-J8A48xdo-5DDEG5PT.js");
      return {
...
var GridContainer = pt(Box)`
  display: grid;
  grid-template-columns: ${({ $hasSideNav }) => $hasSideNav ? `auto 1fr` : "1fr"};
`;
var OverflowingItem = pt(Box)`
  overflow-x: hidden;
`;
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-j-5j-VkL-QVO4GFUZ.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-N3e0bw3O-VZZKOXFS.js");
        return {
...
var JsonInput = (0, import_react10.forwardRef)(
  ({ name, required, label, hint, labelAction, ...props }, ref) => {
    const field = useField(name);
    const fieldRef = useFocusInputField(name);
    const composedRefs = useComposedRefs(ref, fieldRef);
...
var MemoizedJsonInput = (0, import_react10.memo)(JsonInput);
...
var FieldWrapper = pt(Field.Root)`
  height: 3.2rem;
  width: 3.2rem;
...
var AuthPage = () => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-VnmdXnMj-FHZYMM5H.js")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-hpTrGuiB-C5ZIWUXM.js")).FORMS,
    {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-iBPceR0S-ZCQ3T5YJ.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-bJgO6DND-LYHUCRAV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-yBDiueEy-TJRC5LGY.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-pdwlNZO5-XBP2PDTY.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-Bx_qeoOF-VIIHKH5O.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-I7iAq1hY-ZDPENXCL.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-D5r0GV3j-MNYJEN7Y.js").then((n) => n.b);
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-k3F774YE-FSO5245Z.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-gd-uUYo3-4NAZKYK4.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-uZSogyWz-6M4IVRZN.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-PmrZwoCk-PPG56G75.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-dpvub7Dn-G6AXKN5Z.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-vbeM6zm_-HBOGTAN7.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-9nfADKvX-26JEGPGE.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-KuzDXxa_-RUMATE2C.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-4m19d5bJ-2VOEUP73.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-GupUMZgN-M6UYXMK4.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-n2buy2O4-XAFVHEDD.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-wo_TrDuQ-YNSUAHZV.js");
      return {
  ...
  },
  {
    path: "list-plugins",
    lazy: async () => {
      const { ProtectedInstalledPluginsPage } = await import("./InstalledPluginsPage-nFNbVJPm-ICXLULTL.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage--aN208CJ-QFVO5XQG.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-rXyzByjE-ICGFFNJK.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-kEld-u0P-5BQ3EEJ2.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-zYfAXNPg-OIIQVIIN.js");
              return {
...
var StyledWarning = pt(ForwardRef$3)`
  width: 24px;
  height: 24px;
...
//# sourceMappingURL=chunk-ES7XFC2B.js.map
